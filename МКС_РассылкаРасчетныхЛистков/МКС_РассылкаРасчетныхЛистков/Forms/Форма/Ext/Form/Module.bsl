...
Функция СоздатьРасчетныйЛистокПоСотруднику(ФизическиеЛица, МесяцФормированияОтчета, Организация, Вид = "Подробно")
	...
	ПериодНастройка = ОтчетАнализНачисленийИУдержаний.КомпоновщикНастроек.Настройки.ПараметрыДанных.Элементы.Найти("Период");
	ПериодНастройкаПользовательская = ОтчетАнализНачисленийИУдержаний.КомпоновщикНастроек.ПользовательскиеНастройки.Элементы.Найти(ПериодНастройка.ИдентификаторПользовательскойНастройки);
	ПериодНастройкаПользовательская.Значение = СтандартныйПериод;
