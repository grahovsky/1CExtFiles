...
Функция СформироватьСчетНаОплатуПокупателю(ЭлементДерева)
	...
	СчетНаОплатуПокупателюОбъект.Организация = Организация;
	СчетНаОплатуПокупателюОбъект.ОрганизацияПолучатель = Организация;
	СчетНаОплатуПокупателюОбъект.ВалютаДокумента = Константы.ВалютаРегламентированногоУчета.Получить();
...
Функция СоздатьДоговорКонтрагента(ЭлементДерева)
	...
	НовыйДоговорОбъект.Организация = Организация;
